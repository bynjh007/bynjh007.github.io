...
3. If this is your first time, you should set up a configuration (authentification, path, ...). You can do this when you first use the code "./dropbox_uploader.sh".
...
- Also, I faced error when I initially set up the configuration, but it worked at some point without any change in the trials.
